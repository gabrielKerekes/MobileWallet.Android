...
public class SubscribedTopicsAdapter extends RecyclerView.Adapter<SubscribedTopicsAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public CheckBox unsubscribeCheckbox;

        public ViewHolder(View v) {
            super(v);
            topic = (TextView) itemView.findViewById(R.id.topic_text);
            unsubscribeCheckbox = (CheckBox) itemView.findViewById(R.id.unSubscribeCheckbox);
        }
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public SubscribedTopicsAdapter(List<String> topics) {
        this.topics = topics;
    ...
    @Override
    public SubscribedTopicsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                      int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.subscribed_topics_layout, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.unsubscribeCheckbox.setChecked(false);

        holder.unsubscribeCheckbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
